# Le but est de faire jouer l'ordinateur cette fois ci avec la recherche binaire
...
while True:
    ...
    if my_turn:
        ...
        # utilisation de la recherche binaire comparé à la version 2 ou on utilisait random
        mid_index: int = len(computer_options) // 2
